# Common End-to-End Procedure for a Time Series Forecasting Project
...
**References**
- scikit-learn TimeSeriesSplit (expanding-window style)  
- StatsForecast cross-validation (sliding window backtesting concept + implementation)
...
### B. Lag / Rolling / Seasonal Features (careful about leakage)
...
- Strong evidence from forecasting competitions that combinations and hybrid approaches perform very well on average
